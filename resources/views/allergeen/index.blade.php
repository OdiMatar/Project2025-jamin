                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="action-buttons">
                                            ...
                                            <a href="{{ route('allergeen.show', $allergeen->Id) }}"
                                                class="btn-icon view" data-bs-toggle="tooltip" data-bs-title="Details">
                                                <i class="bi bi-eye"></i><span class="label">Details</span>
                                            </a>

                                            <!-- Bewerken -->
                                            <a href="{{ route('allergeen.edit', $allergeen->Id) }}"
                                                class="btn-icon edit" data-bs-toggle="tooltip" data-bs-title="Bewerken">
                                                <i class="bi bi-pencil-square"></i><span class="label">Bewerken</span>
                                            </a>

                                            <!-- Verwijderen -->
                                            <form action="{{ route('allergeen.destroy', $allergeen->Id) }}"
                                                method="POST"
                                                onsubmit="return confirm('Weet je zeker dat je dit allergeen wilt verwijderen?')"
                                                class="m-0 p-0">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn-icon delete" data-bs-toggle="tooltip"
                                                    data-bs-title="Verwijderen">
                                ...
                                <tr>
                                    <td colspan="3">
                                        <div class="empty-state">
                                            ...
                                            <div class="small">Klik op <em>Nieuwe Allergeen</em> om er één toe te
                                                voegen.</div>
                                        </div>
                                    </td>
                                </tr>
