...
<head>
    ...
    <style>
       ...
       ========================================================= */
        ...
        @keyframes float {
            to {
                transform: translate(22px, 28px) scale(1.045);
            }
        }
        ...
        .nav-link-chip:focus {
            box-shadow: 0 0 0 .26rem var(--ring)
        }
        ...
        .btn-q {
            ...
            position: relative;
            z-index: 1;
            /* blijft boven decoratieve lagen */
        }
                                    ...
                                    <td>
                                        @if ($productId)
                                            <a href="{{ route('magazijn.allergenen.show', $productId) }}"
                                                ...
                                                aria-label="Allergeneninformatie bekijken" title="Allergeneninformatie">
                                    ...
                                    <td>
                                        @if ($heeftLeverantie)
                                            <a href="{{ route('leverantie.info.show', ['product' => $productId]) }}"
                                                class="btn-q" title="Leverantie info"
                                                aria-label="Toon leveringsinformatie">?</a>
                                        @else
                                            <span class="btn-q is-disabled" data-bs-toggle="tooltip"
